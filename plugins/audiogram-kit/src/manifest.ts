...
Drop your audio in, replace the placeholder copy, and export. Editing and export are free and never watermarked.`,
  iconUrl: 'https://raw.githubusercontent.com/eli-made/corte-plugins-marketplace/main/plugins/audiogram-kit/assets/icon.png',
  screenshots: [
    'https://raw.githubusercontent.com/eli-made/corte-plugins-marketplace/main/plugins/audiogram-kit/assets/square-layouts.png',
    'https://raw.githubusercontent.com/eli-made/corte-plugins-marketplace/main/plugins/audiogram-kit/assets/vertical-layouts.png',
  ],
    ...
    templates: [
      {
        ...
        slots: [BED_SLOT],
        thumbnailUrl: 'https://raw.githubusercontent.com/eli-made/corte-plugins-marketplace/main/plugins/audiogram-kit/assets/square-pull-quote.png',
      },
      {
        ...
        slots: [BED_SLOT],
        thumbnailUrl: 'https://raw.githubusercontent.com/eli-made/corte-plugins-marketplace/main/plugins/audiogram-kit/assets/square-episode-card.png',
      },
      {
        ...
        slots: [BED_SLOT],
        thumbnailUrl: 'https://raw.githubusercontent.com/eli-made/corte-plugins-marketplace/main/plugins/audiogram-kit/assets/square-guest-intro.png',
      },
      {
        ...
        slots: [BED_SLOT],
        thumbnailUrl: 'https://raw.githubusercontent.com/eli-made/corte-plugins-marketplace/main/plugins/audiogram-kit/assets/vertical-pull-quote.png',
      },
      {
        ...
        slots: [BED_SLOT],
        thumbnailUrl: 'https://raw.githubusercontent.com/eli-made/corte-plugins-marketplace/main/plugins/audiogram-kit/assets/vertical-episode-card.png',
      },
      {
        ...
        slots: [BED_SLOT],
        thumbnailUrl: 'https://raw.githubusercontent.com/eli-made/corte-plugins-marketplace/main/plugins/audiogram-kit/assets/vertical-clip-teaser.png',
      },
    ],
    library: [
      {
        ...
        kind: 'audio',
        name: 'Warm Keys',
        url: 'https://raw.githubusercontent.com/eli-made/corte-plugins-marketplace/main/plugins/audiogram-kit/assets/beds/warm-keys.mp3',
      ...
      },
      {
        ...
        kind: 'audio',
        name: 'Soft Pulse',
        url: 'https://raw.githubusercontent.com/eli-made/corte-plugins-marketplace/main/plugins/audiogram-kit/assets/beds/soft-pulse.mp3',
        tags: ['music', 'bed', 'podcast'],
        durationSeconds: 60,
      },
      {
        ...
        kind: 'audio',
        name: 'Low Strings',
        url: 'https://raw.githubusercontent.com/eli-made/corte-plugins-marketplace/main/plugins/audiogram-kit/assets/beds/low-strings.mp3',
        tags: ['music', 'bed', 'podcast'],
        durationSeconds: 60,
      },
      {
        ...
        kind: 'audio',
        name: 'Clean Lo-Fi',
        url: 'https://raw.githubusercontent.com/eli-made/corte-plugins-marketplace/main/plugins/audiogram-kit/assets/beds/clean-lofi.mp3',
        tags: ['music', 'bed', 'podcast'],
        durationSeconds: 60,
      },
    ],
